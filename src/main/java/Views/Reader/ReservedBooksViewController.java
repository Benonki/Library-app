...
public class ReservedBooksViewController {
    ...
    private void loadReservedBooks() {
        List<Book> reservedBooks = RezerwacjaDAO.getZarezerwowaneKsiazki(UserSession.getUserId());
    ...
    private void handleCancelReservation() {
        ...
        boolean result = RezerwacjaDAO.anulujRezerwacje(UserSession.getUserId(), selected.getId());
        if (result) {
